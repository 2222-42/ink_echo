...
- <a id="REQ-04"></a>**[REQ-04]** Mistral APIは、Newsletter風のスタイルで問い返し文を生成する
- <a id="REQ-05"></a>**[REQ-05]** 問い返し文はトレードオフ指摘、主体性重視、スタート地点振り返り、Doomer脱出などの要素を含みつつ、**必ず非常に短い質問（1〜2文程度）のみ**で構成される
- <a id="REQ-06"></a>**[REQ-06]** 生成された問い返し文はElevenLabs TTS APIにより自然な日本語の音声に変換される。音声として聞き取りやすいよう、回答や説明を含めず、問いかけのみを短く行うこと
