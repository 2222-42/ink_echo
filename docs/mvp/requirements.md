...
- <a id="REQ-04"></a>**[REQ-04]** Mistral APIは、**口調・語彙・比喩はNewsletter風を参考にしつつ、形式は短い質問に厳格限定**して生成する
- <a id="REQ-05"></a>**[REQ-05]** 問い返し文はトレードオフ指摘、主体性重視、スタート地点振り返り、Doomer脱出などの要素を暗示する、**厳密に1文のみの非常に短い質問**で構成される
- <a id="REQ-06"></a>**[REQ-06]** 生成された問い返し文はElevenLabs TTS APIにより自然な日本語の音声に変換される。聞き取りやすいよう、回答や説明を含めず、問いかけのみを50〜80文字以内（厳守100文字以内）で短く行うこと
