...
- <a id="SPEC-08"></a>**[SPEC-08]** Mistralの応答は以下のスタイルを必ず満たす *(要件: [REQ-04](./requirements.md#REQ-04), [REQ-05](./requirements.md#REQ-05))*
  ...
  - **【重要】一切の回答や長々とした説明を行わず、非常に短い質問（1〜2文）のみを返すこと**
- <a id="SPEC-09"></a>**[SPEC-09]** 応答文は声で自然に聞き取れ、かつユーザーが自発的に考える余白を残すため、極端に短い長さ（50〜100文字程度）とする *(要件: [REQ-06](./requirements.md#REQ-06))*
